...
void createLocalU(Matrix &U,mesh m){
    ...
    U.at(0).at(0) +=  upsilon/l;  U.at(0).at(1) += - upsilon/l;
    U.at(1).at(0) += - upsilon/l;  U.at(1).at(1) += upsilon/l;
}
...
Matrix createLocalK(int element,mesh &m){
    ...
    row1.push_back(A.at(0).at(0)+Q.at(0).at(0)); 
    row1.push_back(A.at(0).at(1)+Q.at(0).at(1));
    row1.push_back(C.at(0).at(0)+U.at(0).at(0));                  
    row1.push_back(C.at(0).at(1)+U.at(0).at(1));

    row2.push_back(A.at(1).at(0)+Q.at(1).at(0)); 
    row2.push_back(A.at(1).at(1)+Q.at(1).at(1));
    row2.push_back(C.at(1).at(0)+U.at(1).at(0)); 
    row2.push_back(C.at(1).at(1)+U.at(1).at(1));
